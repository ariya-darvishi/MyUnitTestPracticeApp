...
class FakeShoppingRepositoryAndroidTest : ShoppingRepository {
    ...
    private val observableAllShoppingItem = MutableLiveData<List<ShoppingItem>>(shoppingItems)
    ...
    private fun refreshLiveData() {
        observableAllShoppingItem.postValue(shoppingItems)
    ...
    fun setShouldReturnNetworkError(boolean: Boolean) {
    ...
    override fun observeAllShoppingItems(): LiveData<List<ShoppingItem>> {
        return observableAllShoppingItem
    }
